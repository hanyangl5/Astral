...
//  int nx, ny, nn;
//  unsigned char *tex_data = stbi_load(earth_tex_path.c_str(), &nx, &ny, &nn,
//  0); material *mat = new lambertian(new image_texture(tex_data, nx, ny)); int
//  n = 50; hittable **list = new hittable *[n + 1]; list[0] = new
//  sphere(vec3(0, 0, 0), 1, mat); return new hittable_list(list, 1);
//}
...
//                       new diffuse_light(new constant_texture(vec3(4, 4,
//                       4))));
